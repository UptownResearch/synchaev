...
from chatcontent import DBBenchChatContent, OSChatContent, AlfChatContent, KGChatContent, M2WChatContent, WSChatContent
...
def main(agentbench_split):
    ...
    for i, task in tqdm(enumerate(tasks)):
        ...
        save_json(all_conversations, f"./data/{agentbench_split}/{agentbench_split}-agentinstruct-env_gpt4.json")
